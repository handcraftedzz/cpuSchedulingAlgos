...
int main(int argc, char *argv[]) {
    ...
    std::cout << "Author: Andrew Méndez" << std::endl;     
    std::cout << "Date: 03/18/2025" << std::endl;              
    ...
    int id = 0;
    cout << "Running ./fcfs schedule.txt " << endl; //this is the only line of code i added to the FCFS DRIVER!
